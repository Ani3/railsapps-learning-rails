...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/rvm/rubies/ruby-2.0.0-p0")
  ...
  CONFIG["configure_args"] = " '--disable-install-doc' '--prefix=/usr/local/rvm/rubies/ruby-2.0.0-p0' '--enable-shared' '--enable-load-relative' '--sysconfdir=/etc'"
